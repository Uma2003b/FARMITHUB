...
class_descriptions = {
    ...
    'Corn___Cercospora_leaf_spot': 'Gray leaf spot detected. Use resistant varieties and rotate crops.',
    'Corn___Common_rust': 'Common rust detected. Remove infected leaves and apply fungicide.',
    'Corn___healthy': 'The corn plant is healthy.',
    'Grape___Black_rot': 'Black rot detected on grapes. Remove infected parts.',
    'Grape___Esca': 'Esca disease detected. Prune and burn affected wood.',
    ...
    'Tomato___Spider_mites': 'Spider mites present. Use insecticidal soap.',
    'Tomato___Target_Spot': 'Target spot found. Use proper spacing and apply fungicide.',
    'Tomato___Yellow_Leaf_Curl_Virus': 'Viral infection found. Remove infected plants.',
    'Tomato___mosaic_virus': 'Mosaic virus detected. Control aphid population.',
