...
crop_recommendation_bp = None

crop_recommendation_bp = Blueprint(
    'crop_recommendation',
    __name__,
    template_folder=os.path.join('Crop Recommendation', 'templates'),
    static_folder=os.path.join('Crop Recommendation', 'static'),
    static_url_path='/crop_recommendation/static'
)
logger = logging.getLogger(__name__)

# Load model and label encoder
model_path = os.path.join('Crop Recommendation', 'model', 'rf_model.pkl')
le_path = os.path.join('Crop Recommendation', 'model', 'label_encoder.pkl')
